...
namespace PMLabs
{
    ...
    class Program
    {
        ...
        static readonly KeyCallback kc = KeyProcessor;
        ...
        public static void DrawScene(Window window, float angle_x, float angle_y)
        {
            ...
            GL.VertexAttribPointer(DemoShaders.spColored.A("vertex"), 4,
            VertexAttribPointerType.Float, false, 0, MyTeapot.vertices);
            GL.VertexAttribPointer(DemoShaders.spColored.A("color"), 4,
            VertexAttribPointerType.Float, false, 0, MyTeapot.colors);
