...
namespace PMLabs
{
    ...
    class Program
    {
        static Sphere sun = new Sphere(0.5f, 36f, 36f);
        static Sphere planet1 = new Sphere(0.2f, 36f, 16f);
        static Sphere moon1 = new Sphere(0.1f, 36f, 36f);
        static Sphere planet2 = new Sphere(0.25f, 36f, 36f);
        static Sphere moon2 = new Sphere(0.07f, 36f, 36f);
        ...
        public static void DrawScene(Window window, float angle)
        {
            ...
            Mt1 = Mt1 * mat4.Rotate(angle, new vec3(0.0f, 1.0f, 0.0f));
            GL.UniformMatrix4(DemoShaders.spConstant.U("M"), 1, false, Mt1.Values1D);
            sun.drawWire();
            
            //Ziemia1
            mat4 Mt2 = Mt1;
            Mt2 = Mt2 * mat4.Translate(new vec3(1.7f, 0, 0));
            Mt2 = Mt2 * mat4.Rotate(angle, new vec3(0.0f, 1.0f, 0.0f));
            GL.UniformMatrix4(DemoShaders.spConstant.U("M"), 1, false, Mt2.Values1D);
            planet1.drawWire();
            
            // księżyc Ziemii
            mat4 Mt3 = Mt2;
            Mt3 = Mt3 * mat4.Translate(new vec3(0.4f, 0, 0));
            Mt3 = Mt3 * mat4.Rotate(angle, new vec3(0.0f, 1.0f, 0.0f));
            GL.UniformMatrix4(DemoShaders.spConstant.U("M"), 1, false, Mt3.Values1D);
            moon1.drawWire();

            //Ziemia2
            mat4 Mt2_2 = Mt1;
            Mt2_2 = Mt2_2 * mat4.Translate(new vec3(1.7f, 1.0f, 0));
            Mt2_2= Mt2_2 * mat4.Rotate(angle, new vec3(0.0f, 0.0f, 1.0f));
            GL.UniformMatrix4(DemoShaders.spConstant.U("M"), 1, false, Mt2_2.Values1D);
            planet2.drawWire();

            // księżyc2
            mat4 Mt3_2 = Mt2_2;
            Mt3_2 = Mt3_2 * mat4.Translate(new vec3(0.4f, 0, 0));
            Mt3_2 = Mt3_2 * mat4.Rotate(angle, new vec3(0.0f, 0.0f, 1.0f));
            GL.UniformMatrix4(DemoShaders.spConstant.U("M"), 1, false, Mt3_2.Values1D);
            moon2.drawWire();
