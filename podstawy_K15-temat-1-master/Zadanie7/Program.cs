...
namespace PMLabs
{
    ...
    class Program
    {
        ...
        public static void DrawScene(Window window, float angle)
        {
            ...
            Mt1 = Mt1 * mat4.Translate(new vec3(1.05f, 0, 0));
            ...
            {
                mat4 Mk = Mt1;
                Mk = Mk * mat4.Rotate(glm.Radians(30.0f * i), new vec3(0, 0, 1.0f));
                Mk = Mk * mat4.Translate(new vec3(1.0f, 0, 0));
                Mk = Mk * mat4.Scale(new vec3(0.1f, 0.1f, 0.1f));
                GL.UniformMatrix4(DemoShaders.spConstant.U("M"), 1, false, Mk.Values1D);
                Cube.cube.drawWire();
            }

            mat4 Mt2 = mat4.Identity;
            Mt2 = Mt2 * mat4.Translate(new vec3(-1.05f, 0, 0));
            Mt2 = Mt2 * mat4.Rotate(-angle + glm.Radians(11f), new vec3(0.0f, 0.0f, 1.0f));
